...
namespace Pantry.Controllers
{
    public class ItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ItemName,ItemQuantity")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ItemName,ItemQuantity")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
